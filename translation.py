...
🔺➡️ ɢᴏ ᴛᴏ ᴛʜᴇ ➠ @File_To_Link_Prime_Bot sᴇɴᴅ ᴀ ғɪʟᴇ ғʀᴏᴍ ᴛʜᴇʀᴇ. ғʀᴏᴍ ᴛʜᴇʀᴇ ʏᴏᴜ ᴡɪʟʟ ʙᴇ ɢɪᴠᴇɴ ᴛᴡᴏ ʟɪɴᴋs, ᴏɴᴇ ғᴏʀ ᴅᴏᴡɴʟᴏᴀᴅ ᴀɴᴅ ᴏɴᴇ ғᴏʀ sᴛʀᴇᴀᴍ. ʏᴏᴜ ʜᴀᴠᴇ ᴛᴏ ᴄᴏᴩʏ ᴛʜᴇ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ ᴀɴᴅ ᴩᴀsᴛᴇ ɪᴛ ʜᴇʀᴇ.⬅️
...
🔻 📸 **ᴛʜᴇ ғɪʀsᴛ ᴛʜɪɴɢ ᴛᴏ ᴅᴏ ɪs ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ sᴇᴛ ᴀ ᴄᴜsᴛᴏᴍ ᴛʜᴜᴍʙɴᴀɪʟ, ғɪʀsᴛ sᴇɴᴅ ɪᴛ ᴅɪʀᴇᴄᴛʟʏ ʜᴇʀᴇ ᴀɴᴅ ɪ ᴡɪʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ sᴇʟᴇᴄᴛ ɪᴛ.** 📸

🔻 ➡️ ɢᴏ ᴛᴏ ᴛʜᴇ ➠ @File_To_Link_Prime_Bot sᴇɴᴅ ᴀ ғɪʟᴇ ғʀᴏᴍ ᴛʜᴇʀᴇ. ғʀᴏᴍ ᴛʜᴇʀᴇ ʏᴏᴜ ᴡɪʟʟ ʙᴇ ɢɪᴠᴇɴ ᴛᴡᴏ ʟɪɴᴋs, ᴏɴᴇ ғᴏʀ ᴅᴏᴡɴʟᴏᴀᴅ ᴀɴᴅ ᴏɴᴇ ғᴏʀ sᴛʀᴇᴀᴍ. ʏᴏᴜ ʜᴀᴠᴇ ᴛᴏ ᴄᴏᴩʏ ᴛʜᴇ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ ᴀɴᴅ ᴩᴀsᴛᴇ ɪᴛ ʜᴇʀᴇ. ⬅️

🔻 ʜᴏᴡ ᴛᴏ ᴜᴘʟᴏᴀᴅ ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋs <a href="https://t.me/Prime_Movie_Watch_Dawnload/84">ᴛᴜᴛᴏʀɪᴀʟ ᴠɪᴅᴇᴏ</a>

🔻 sᴇɴᴅ ᴍᴇ ᴛʜᴇ ɢᴏᴏɢʟᴇ ᴅʀɪᴠᴇ | ʏᴛᴅʟ | ᴅɪʀᴇᴄᴛ ʟɪɴᴋs.

🔻 ᴛʜᴇɴ ᴛᴡᴏ ᴏᴩᴛɪᴏɴs ᴡɪʟʟ ᴀᴩᴩᴇᴀʀ ғʀᴏᴍ ᴛʜᴇʀᴇ: ᴛʜᴇ ғɪʀsᴛ ɪs ᴀ ᴠɪᴅᴇᴏ ғɪʟᴇ ᴡɪᴛʜ ᴀ ᴛʜᴜᴍʙɴᴀɪʟ, ᴀɴᴅ ᴛʜᴇ ᴏᴛʜᴇʀ ɪs ᴀ ᴅɪʀᴇᴄᴛ ғɪʟᴇ. ʏᴏᴜ ᴄᴀɴ ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ᴏɴᴇ ʏᴏᴜ ʟɪᴋᴇ.

🔻 sᴇʟᴇᴄᴛ ᴛʜᴇ ᴅᴇsɪʀᴇᴅ ᴏᴘᴛɪᴏɴ

🔻 ᴛʜᴇɴ ʙᴇ ʀᴇʟᴀxᴇᴅ ʏᴏᴜʀ ғɪʟᴇ ᴡɪʟʟ ʙᴇ ᴜᴘʟᴏᴀᴅᴇᴅ sᴏᴏɴ..</b>

♋💬 ɪғ ʏᴏᴜ ғᴀᴄᴇ ᴀɴʏ ᴩʀᴏʙʟᴇᴍs ᴏʀ ᴅᴏɴ'ᴛ ᴜɴᴅᴇʀsᴛᴀɴᴅ sᴏᴍᴇᴛʜɪɴɢ, ʏᴏᴜ ᴄᴀɴ ᴄᴏɴᴛᴀᴄᴛ ᴜs ᴏɴ ᴏᴜʀ sᴜᴩᴩᴏʀᴛ ɢʀᴏᴜᴩ ➠ <a href='https://t.me/Prime_Botz_Support'>ᴘʀɪᴍᴇ ʙᴏᴛz sᴜᴩᴩᴏʀᴛ ɢʀᴏᴜᴩ</a>💬
"""

    TECH_VJ_ABOUT_TEXT = """
<b>♻️ ᴍʏ ɴᴀᴍᴇ : ᴜʀʟ ᴜᴘʟᴏᴀᴅᴇʀ ʙᴏᴛ

🌀 ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ : <a href="https://t.me/Prime_botz">ᴘʀɪᴍᴇ ʙᴏᴛz</a>
...
👲 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href="https://t.me/Prime_Nayem">ᴍʀ.ᴩʀɪᴍᴇ</a></b>
...
"""
    ...
    TECH_VJ_DOWNLOAD_START = "<b>📥 ᴘʀɪᴍᴇ ʙᴏᴛz ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ ғɪʟᴇ 📥...</b>"
    TECH_VJ_UPLOAD_START = "<b>♻️ ᴘʀɪᴍᴇ ʙᴏᴛz ᴜᴘʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ ғɪʟᴇ ♻️...</b>"
    ...
    TECH_VJ_NO_VOID_FORMAT_FOUND = "<b>ᴇʀʀᴏʀ...\nᴍʀ.ᴩʀɪᴍᴇ ꜱᴀɪᴅ: {}</b>\n⚠️ ɪғ ᴛʜᴇʀᴇ ɪs ᴀ ᴍᴀᴊᴏʀ ᴩʀᴏʙʟᴇᴍ,\n ʏᴏᴜ ᴄᴀɴ ᴍᴇssᴀɢᴇ ᴏᴜʀ ➠ <a href='https://t.me/Prime_Botz_Support'>ᴘʀɪᴍᴇ ʙᴏᴛz sᴜᴩᴩᴏʀᴛ ɢʀᴏᴜᴩ</a>"
